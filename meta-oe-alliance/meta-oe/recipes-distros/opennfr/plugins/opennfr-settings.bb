...
do_install() {
    ...
    for f in mp_pluginliste bouquets* userbouquet* autotimer.xml cert.pem key.pem lamedb lamedb5 menusort.xml pluginsort.xml settings lcndb epgimport.conf blacklist whitelist
    do
